...
public class Connections {
	...
	public static Connection getConnection() throws SQLException {
		...
		config.setJdbcUrl("jdbc:mysql://"+System.getProperty("sqlhostname")+":"+System.getProperty("sqlserverport")+"/"+System.getProperty("sqldatabasename")+"?useUnicode=true&characterEncoding=UTF-8"); // see appengine-web.xml
